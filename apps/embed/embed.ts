...
;(function () {
  ...
  if (!organizationId) {
    console.error("VERTO Widget: data-organization-id attribute is required")
    return
  }
  ...
  function render() {
    ...
    container.id = "verto-widget-container"
  ...
  function hide() {
    if (container && button) {
      ...
      button.innerHTML = chatBubbleIcon
      button.style.background = "#6e56cf"
    }
  }
